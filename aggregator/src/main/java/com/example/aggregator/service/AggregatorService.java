...
public class AggregatorService {
    ...
    public List<Entry> getWordsStartingWith(String word) {
        return restClient.getWordsStartingWith(word);
    }

    public List<Entry> getWordsEndingWith(String word) {
        return restClient.getWordsEndingWith(word);
    }
