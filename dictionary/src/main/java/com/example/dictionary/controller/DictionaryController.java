...
public class DictionaryController {
    ...
    public List<Entry> getWordsThatContain(@PathVariable String value) throws WordNotFoundException {
        ...
        long nanoSeconds = sw.getLastTaskTimeNanos();
        String message = new StringBuilder("Retrieved entry for words that contain [")
                .append(value)
                .append("] containing ")
                .append(entries.size())
                .append(" entries in ")
    ...
    public List<Entry> getWordThatContainConsecutiveLetters() throws WordNotFoundException {
    ...
    @QueryMapping //a part of graphql library
